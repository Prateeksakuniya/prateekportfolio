...
import VinayakSingh from "../../assets/pk.jpg";
    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            Hi there! I'm Prateek, an enthusiastic Software Engineer skilled in web development, machine learning, and scalable software solutions
          </p>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={400}>
          <div className="education">
            <h3>Education:</h3>
            <h4> Bachlore of Technology (B.tech)</h4>
            <p>Poornima Institute of Engineering & Technology, Jaipur | July 2021 - 2025</p>
            <p>7.82 CGPA</p>
          </div>
        </ScrollAnimation>
        <ScrollAnimation animateIn="fadeInLeft" delay={550}>
          <div className="experience">
            ...
            <p>Xiconet Technology | March 2025 - Present</p>
            <p>Delhi, India</p>
          </div>
        </ScrollAnimation>
      ...
      <div className="about-image">
        <ScrollAnimation animateIn="fadeInRight" delay={0.23 * 1000}>
          <img src={VinayakSingh} alt="Prateek Khandelwal" />
        </ScrollAnimation>
      </div>
    </Container>
  )
